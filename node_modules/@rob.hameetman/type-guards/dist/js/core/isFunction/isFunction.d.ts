 ...
 */
export declare const isFunction: <T = unknown, U = unknown>(value: unknown, args?: readonly U[], isT?: ((value: unknown) => value is T) | undefined, isU?: ((value: unknown) => value is U) | undefined) => value is (...args: readonly U[]) => T;
