 ...
 */
export declare const isVoidFunction: <T = unknown>(value: unknown, args?: ReadonlyArray<unknown>, isT?: ((value: unknown) => value is T) | undefined) => value is (...args: readonly T[]) => void;
